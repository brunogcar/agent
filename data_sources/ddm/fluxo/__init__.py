...
_MODE_MAP = {
    ...
    "summary":    ("data_sources.ddm.fluxo.query_engine",    "summary"),
    "ticker":     ("data_sources.ddm.fluxo.query_engine",    "by_date"),
    "status":     ("data_sources.ddm.fluxo.status_reporter", "status"),
}
