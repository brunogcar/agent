...
def route(mode: str = "", **kwargs) -> dict:
    ...
    try:
        if mode == "sync_all":
            from data_sources.ddm.focus.sync_engine import sync_all as _fn
        elif mode == "sync_index":
            from data_sources.ddm.focus.sync_engine import sync_index as _fn
        elif mode == "focus_data":
            from data_sources.ddm.focus.query_engine import all_data as _fn
        elif mode == "last":
            from data_sources.ddm.focus.query_engine import last_value as _fn
        elif mode == "search":
            from data_sources.ddm.focus.query_engine import search as _fn
        elif mode == "summary":
            from data_sources.ddm.focus.query_engine import summary as _fn
        elif mode == "status":
            from data_sources.ddm.focus.status_reporter import status as _fn
        elif mode == "indicator":
            from data_sources.ddm.focus.query_engine import focus_by_indicator as _fn
        else:
