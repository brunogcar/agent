"""Tests for skills/cvm/historical/metrics/dpa.py + engines/dividends.py.
...
import pytest
from skills.cvm.historical.metrics import dpa as dpa_metric
from skills.cvm.historical.engines import dividends as dividends_engine
...
def _mock_engines(monkeypatch):
    ...
    monkeypatch.setattr(
        "skills.cvm.historical.metrics.dpa.price_series",
        lambda ticker, df, dt: list(MOCK_PRICES),
    )
    monkeypatch.setattr(
        "skills.cvm.historical.metrics.dpa.dividends_at",
        lambda ticker, date: 1.85 if date >= "2023-12-31" else 1.50,
    )
    monkeypatch.setattr(
        "skills.cvm.historical.metrics.dpa.ttm_earnings_periods",
        lambda company: list(MOCK_EARNINGS_PERIODS),
    )
    monkeypatch.setattr(
        "skills.cvm.historical.metrics.dpa.shares_periods",
...
class TestDpaAt:
    def test_basic_computation(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: 1.85
        )
    ...
    def test_no_data_returns_none(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: None
        )
    ...
    def test_zero_dividends_returns_zero(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: 0.0
        )
...
class TestDyAt:
    def test_basic_computation(self, monkeypatch):
        """dy_at = DPA / price."""
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.price_at", lambda t, d: 38.0)
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: 1.85)
    ...
    def test_missing_price(self, monkeypatch):
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.price_at", lambda t, d: None)
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: 1.85)
        assert dpa_metric.dy_at("PETR4", "2024-06-30") is None

    def test_zero_price_returns_none(self, monkeypatch):
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.price_at", lambda t, d: 0.0)
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: 1.85)
        assert dpa_metric.dy_at("PETR4", "2024-06-30") is None

    def test_no_dividends_data(self, monkeypatch):
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.price_at", lambda t, d: 38.0)
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: None)
        assert dpa_metric.dy_at("PETR4", "2024-06-30") is None

    def test_zero_dividends_returns_zero_yield(self, monkeypatch):
        """Company pays no dividends → yield = 0.0 (valid, not None)."""
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.price_at", lambda t, d: 38.0)
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: 0.0)
        result = dpa_metric.dy_at("PETR4", "2024-06-30")
        assert result == 0.0
...
class TestPayoutAt:
    def test_basic_computation(self, monkeypatch):
        ...
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: 1.85)
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.ttm_earnings_at", lambda c, d: 110e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.shares_at", lambda c, d: 13e9)
    ...
    def test_negative_earnings_returns_none(self, monkeypatch):
        ...
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: 1.85)
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.ttm_earnings_at", lambda c, d: -50e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.dpa.shares_at", lambda c, d: 13e9)
        assert dpa_metric.payout_at("PETR4", "2024-06-30") is None
...
class TestDpaHistory:
    ...
    def test_empty_prices_returns_empty(self, monkeypatch):
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.dpa.price_series", lambda t, df, dt: []
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.dpa.dividends_at", lambda t, d: 1.85
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.dpa.ttm_earnings_periods", lambda c: []
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.dpa.shares_periods", lambda c: []
        )
