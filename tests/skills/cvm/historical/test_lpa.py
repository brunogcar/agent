"""Tests for skills/cvm/historical/metrics/lpa.py -- LPA + P/L metric.
...
import pytest
from skills.cvm.historical.metrics import lpa as lpa_metric
...
def _mock_engines(monkeypatch):
    ...
    monkeypatch.setattr(
        "skills.cvm.historical.metrics.lpa.price_series",
        lambda ticker, df, dt: list(MOCK_PRICES),
    )
    monkeypatch.setattr(
        "skills.cvm.historical.metrics.lpa.ttm_earnings_periods",
        lambda company: list(MOCK_EARNINGS_PERIODS),
    )
    monkeypatch.setattr(
        "skills.cvm.historical.metrics.lpa.shares_periods",
...
class TestLpaAt:
    def test_basic_computation(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.ttm_earnings_at", lambda c, d: 110e9
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.shares_at", lambda c, d: 13e9
        )
    ...
    def test_missing_earnings(self, monkeypatch):
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.ttm_earnings_at", lambda c, d: None
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.shares_at", lambda c, d: 13e9
        )
    ...
    def test_missing_shares(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.shares_at", lambda c, d: None
        )
        assert lpa_metric.lpa_at("PETR4", "2024-06-15") is None
    ...
    def test_negative_earnings_returns_none(self, monkeypatch):
        ...
        """
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.ttm_earnings_at", lambda c, d: -50e9
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.shares_at", lambda c, d: 13e9
        )
    ...
    def test_zero_earnings_returns_none(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.ttm_earnings_at", lambda c, d: 0
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.shares_at", lambda c, d: 13e9
        )
...
class TestPeAt:
    def test_basic_computation(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.price_at", lambda t, d: 38.0
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.lpa.ttm_earnings_at", lambda c, d: 110e9
        )
    ...
    def test_missing_price(self, monkeypatch):
        monkeypatch.setattr("skills.cvm.historical.metrics.lpa.price_at", lambda t, d: None)
        monkeypatch.setattr("skills.cvm.historical.metrics.lpa.ttm_earnings_at", lambda c, d: 110e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.lpa.shares_at", lambda c, d: 13e9)
        assert lpa_metric.pe_at("PETR4", "2024-06-15") is None

    def test_zero_price_returns_none(self, monkeypatch):
        monkeypatch.setattr("skills.cvm.historical.metrics.lpa.price_at", lambda t, d: 0.0)
        monkeypatch.setattr("skills.cvm.historical.metrics.lpa.ttm_earnings_at", lambda c, d: 110e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.lpa.shares_at", lambda c, d: 13e9)
        assert lpa_metric.pe_at("PETR4", "2024-06-15") is None
    ...
    def test_negative_earnings_returns_none(self, monkeypatch):
        ...
        monkeypatch.setattr("skills.cvm.historical.metrics.lpa.price_at", lambda t, d: 38.0)
        monkeypatch.setattr("skills.cvm.historical.metrics.lpa.ttm_earnings_at", lambda c, d: -50e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.lpa.shares_at", lambda c, d: 13e9)
        assert lpa_metric.pe_at("PETR4", "2024-06-15") is None
