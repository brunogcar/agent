...
import pytest
from skills.cvm.historical.metrics import ev_ebitda as ev_metric
from skills.cvm.historical.engines import cash as cash_engine
from skills.cvm.historical.engines import da as da_engine
...
class TestEbitdaPsAt:
    def test_basic_computation(self, monkeypatch):
        ...
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.ebit_at", lambda c, d: 70e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.da_at", lambda c, d: 15e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.shares_at", lambda c, d: 13e9)
    ...
    def test_missing_ebit(self, monkeypatch):
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.ebit_at", lambda c, d: None)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.da_at", lambda c, d: 15e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.shares_at", lambda c, d: 13e9)
    ...
    def test_missing_da(self, monkeypatch):
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.ebit_at", lambda c, d: 70e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.da_at", lambda c, d: None)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.shares_at", lambda c, d: 13e9)
        assert ev_metric.ebitda_ps_at("PETR4", "2024-06-30") is None

    def test_negative_ebitda_returns_none(self, monkeypatch):
        """EBIT + D&A <= 0 -> EBITDA <= 0 -> None."""
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.ebit_at", lambda c, d: -20e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.da_at", lambda c, d: 15e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.shares_at", lambda c, d: 13e9)
        assert ev_metric.ebitda_ps_at("PETR4", "2024-06-30") is None
...
class TestEvEbitdaAt:
    def test_basic_computation(self, monkeypatch):
        ...
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.price_at", lambda t, d: 38.0)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.shares_at", lambda c, d: 13e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.debt_at", lambda c, d: 100e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.cash_at", lambda c, d: 30e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.ebit_at", lambda c, d: 70e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.da_at", lambda c, d: 15e9)
        # EBITDA = 70e9 + 15e9 = 85e9
    ...
    def test_missing_price(self, monkeypatch):
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.price_at", lambda t, d: None)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.shares_at", lambda c, d: 13e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.debt_at", lambda c, d: 100e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.cash_at", lambda c, d: 30e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.ebit_at", lambda c, d: 70e9)
    ...
    def test_missing_debt(self, monkeypatch):
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.price_at", lambda t, d: 38.0)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.shares_at", lambda c, d: 13e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.debt_at", lambda c, d: None)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.cash_at", lambda c, d: 30e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.ebit_at", lambda c, d: 70e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.da_at", lambda c, d: 15e9)
        assert ev_metric.ev_ebitda_at("PETR4", "2024-06-30") is None
    ...
    def test_missing_cash(self, monkeypatch):
        ...
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.shares_at", lambda c, d: 13e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.debt_at", lambda c, d: 100e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.cash_at", lambda c, d: None)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.ebit_at", lambda c, d: 70e9)
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.da_at", lambda c, d: 15e9)
        assert ev_metric.ev_ebitda_at("PETR4", "2024-06-30") is None
...
class TestEvEbitdaHistory:
    def test_basic_shape(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.ev_ebitda.price_series",
            lambda t, df, dt: [{"date": "2024-01-15", "close": 38.0}],
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.ev_ebitda.shares_periods",
            lambda c: [{"date": "2024-01-01", "shares": 13e9}],
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.ev_ebitda.debt_periods",
            lambda c: [{"date": "2024-01-01", "debt": 100e9}],
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.ev_ebitda.cash_periods",
            lambda c: [{"date": "2024-01-01", "cash": 30e9}],
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.ev_ebitda.ebit_periods",
            lambda c: [{"date": "2024-01-01", "ttm_ebit": 70e9}],
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.ev_ebitda.da_periods",
    ...
    def test_empty_prices_returns_empty(self, monkeypatch):
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.price_series", lambda t, df, dt: [])
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.shares_periods", lambda c: [])
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.debt_periods", lambda c: [])
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.cash_periods", lambda c: [])
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.ebit_periods", lambda c: [])
        monkeypatch.setattr("skills.cvm.historical.metrics.ev_ebitda.da_periods", lambda c: [])
...
class TestRoicCashUpdate:
    def test_roic_subtracts_cash_when_available(self, monkeypatch):
        ...
        monkeypatch.setattr("skills.cvm.historical.engines.cash.cash_at", lambda c, d: 50e9)
