"""Tests for skills/cvm/historical/metrics/roe.py -- ROE fundamental ratio.
...
import pytest
from skills.cvm.historical.metrics import roe as roe_metric
...
def _mock_engines(monkeypatch):
    ...
    monkeypatch.setattr(
        "skills.cvm.historical.metrics.roe.ttm_earnings_periods",
        lambda company: list(MOCK_EARNINGS_PERIODS),
    )
    monkeypatch.setattr(
        "skills.cvm.historical.metrics.roe.pl_periods",
...
class TestRoeAt:
    def test_basic_computation(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.ttm_earnings_at", lambda c, d: 120e9
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.pl_at", lambda c, d: 350e9
        )
    ...
    def test_missing_earnings(self, monkeypatch):
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.ttm_earnings_at", lambda c, d: None
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.pl_at", lambda c, d: 350e9
        )
    ...
    def test_missing_pl(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.pl_at", lambda c, d: None
        )
        assert roe_metric.roe_at("PETR4", "2024-06-30") is None
    ...
    def test_negative_earnings_returns_none(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.ttm_earnings_at", lambda c, d: -50e9
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.pl_at", lambda c, d: 350e9
        )
    ...
    def test_zero_earnings_returns_none(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.ttm_earnings_at", lambda c, d: 0
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.pl_at", lambda c, d: 350e9
        )
    ...
    def test_negative_pl_returns_none(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.pl_at", lambda c, d: -50e9
        )
        assert roe_metric.roe_at("PETR4", "2024-06-30") is None
    ...
    def test_zero_pl_returns_none(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.pl_at", lambda c, d: 0
        )
        assert roe_metric.roe_at("PETR4", "2024-06-30") is None
...
class TestRoeHistory:
    ...
    def test_empty_periods_returns_empty(self, monkeypatch):
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.ttm_earnings_periods", lambda c: []
        )
        monkeypatch.setattr(
            "skills.cvm.historical.metrics.roe.pl_periods", lambda c: []
        )
