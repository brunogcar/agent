"""Tests for skills/cvm/calculations/_registry.py -- central auto-discovery registry.
...
class TestEngineAutoDiscovery:
    ...
    def test_list_engines_market_category(self):
        ...
        # [v1.13] beta + selic engines are also category="market"
        assert "beta" in market_engines
        assert "selic" in market_engines
        assert len(market_engines) == 4
