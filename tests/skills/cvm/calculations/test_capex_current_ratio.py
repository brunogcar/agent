"""Tests for CapEx/Revenue + Current Ratio metrics.

Also tests the 3 engines they depend on: capex, total_assets, current_liabilities.
"""
...
from skills.cvm.calculations.engines import capex as capex_engine
from skills.cvm.calculations.engines import total_assets as ta_engine
from skills.cvm.calculations.engines import current_liabilities as cl_engine
...
class TestNewEngineRegistration:
    ...
    def test_engine_count(self):
        """Verify total engine count is at least the v2.1 baseline (18).
    ...
    def test_metric_count(self):
        """Verify total metric count is at least the v2.1 baseline (21).
