...
class TestVerificationNodeLogic:
    ...
    def test_verify_sets_passed_on_valid_ast(self, base_graph_state):
        ...
        with patch("workflows.autocode_impl.nodes.verify._call", return_value='{"automated_checks_passed": true, "checks": {"syntax": {"passed": true}, "tests": {"passed": true}, "spec": {"passed": true}, "regressions": {"passed": true}, "cleanliness": {"passed": true}}, "summary": "All checks passed"}'), \
...
class TestStateMutationCompliance:
    ...
    def test_execute_returns_expected_keys(self, base_graph_state, temp_workspace):
        ...
        with patch("workflows.autocode_impl.nodes.execute._call", return_value="code"):
