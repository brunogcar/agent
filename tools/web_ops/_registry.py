"""Auto-registration registry for web actions.
...
system fully extensible: to add a new web action, simply:
 1. Create a new file in tools/web_ops/actions/
 2. Define a handler decorated with @register_action("web", "action_name")
 3. The action is immediately available via the web() tool
...
Thread Safety:
 ...
 if called concurrently (httpx.Client singleton is thread-safe).
"""
from __future__ import annotations

from typing import Any, Callable, Dict, List, Optional

# Global dispatch table: {"web": {"search": {"func": ..., "help": ...}}}
...
def register_action(
    ...
    """Decorator to register a web action handler function with metadata.

    Args:
        tool_name: Tool namespace. Always "web" for web actions.
        action_name: Action identifier exposed to the LLM (e.g., "search", "scrape").
