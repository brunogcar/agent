...
@register_action(
    "file",
    "write_pptx",
    help_text="""Write data to a PowerPoint file using python-pptx. Content is a JSON list of slide dicts.
Required: path, content (JSON list of {title, body, bullets, layout, notes})
Returns: {path, size, slide_count}""",
    examples=[
        'file(action="write_pptx", path="slides.pptx", content=\'[{"title":"Intro","bullets":["A","B"]}]\')',
    ],
)
