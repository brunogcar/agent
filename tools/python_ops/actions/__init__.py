"""python_ops/actions/ — Action handler modules.

Each module here imports `register_action` from tools.python_ops._registry
...
@register_action("python", "<action_name>", ...). The facade will pick it
