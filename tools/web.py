...
@meta_tool(
    ...
    doc_sections=[
        ...
        " | JS-rendered page (markdown) | web(crawl) | crawl4ai, handles JS natively, returns markdown (v1.3 prototype) |",
        " | JS-rendered page (interactive) | browser(navigate+text_content) | Renders JavaScript, full browser control |",
        "",
