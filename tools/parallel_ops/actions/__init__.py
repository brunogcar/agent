"""parallel_ops/actions/ — Action handler modules.

Each module here imports `register_action` from tools.parallel_ops._registry
...
@register_action("parallel", "<action_name>", ...). The facade will pick it
