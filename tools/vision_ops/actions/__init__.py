"""tools/vision_ops/actions/ — Action handler modules.

Each module here imports `register_action` from tools.vision_ops._registry
...
@register_action("vision", "<action_name>", ...). The facade will pick it
