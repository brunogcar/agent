...
@meta_tool(
    ...
    doc_sections=[
        ...
        ' report(action="table", title="Financials", data={"sections":[{"title":"Q","columns":["P","Rev"],"rows":[["1T26",1000]]}]})',
        ' report(action="table", title="PETR4 Financials", data=<skill JSON>, config={"adapter":"financials_quarterly"})',
        ' report(action="export", data=<skill JSON>, config={"format":"xlsx","adapter":"valuation_ratios"})',
