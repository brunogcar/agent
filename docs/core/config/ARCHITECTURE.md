...
| `core/config_backend/execution.py` | 97 | `_init_execution(cfg)` — 4 parallel-execution (Phase 7), 2 agent-cache (Bug #19), 1 understand-batch (Bug #17), 5 execution/autocode, 4 autoresearch (v1.0), 9 autocode-v1.3/swarm flags. |
