...
*Last updated: 2026-07-25 (v1.7 — workflow tool v1.2 reference; no changes to base.py itself). See [ARCHITECTURE.md](ARCHITECTURE.md) for file maps, [API.md](API.md) for utility signatures, [INSTRUCTIONS.md](INSTRUCTIONS.md) for AI editing rules.*
