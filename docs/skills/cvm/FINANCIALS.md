...
| [API.md](financials/API.md) | 10 modes: quarterly, annual, complete, summary, dashboard, bpa, bpp, dre, dfc, dva |
...
*Last updated: 2026-07-29 (v1.12 — 7-tab dashboard reorg + 5 standalone statement modes + generic statement adapter; see CHANGELOG.md).*
