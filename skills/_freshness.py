...
def get_freshness() -> dict[str, str]:
    ...
    # DDM dividends — sync_state table (single-row, slug='dividends')
    # [v1] Wired alongside the ddm-dividends entry in skills/_base.py sync_map.
    # Mirrors the b3_dividends entry: reads synced_at from sync_state table.
    try:
