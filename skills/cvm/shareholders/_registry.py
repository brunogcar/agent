"""skills/cvm/shareholders/_registry.py — Mode registry + auto-discovery.

Central dispatch table for shareholders modes. Each mode lives in its own file
...
@dataclass
class ModeSpec:
    """Specification for a shareholders mode.

    Attributes:
        name:        Mode name (file name without .py). "shareholders", "summary", etc.
...
def register_mode(
    ...
    *,
    ...
    """Decorator to register a shareholders mode.

    Usage in modes/shareholders.py:
        @register_mode("shareholders", description="...", params={...})
        def shareholders(company="") -> dict:
            ...
    """
