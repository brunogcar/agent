"""engines/dre/cogs.py -- TTM (trailing twelve months) Cost of Goods Sold engine.

Mirrors engines/dre/revenue.py with one change: CVM account code 3.02
...
Usage:
    from skills.cvm.calculations.engines.dre.cogs import cogs_at
