"""engines/dre/ebt.py -- TTM (trailing twelve months) EBT (Earnings Before Tax) engine.

Mirrors engines/dre/ebit.py with one change: CVM account code 3.07
...
Usage:
    from skills.cvm.calculations.engines.dre.ebt import ebt_at
