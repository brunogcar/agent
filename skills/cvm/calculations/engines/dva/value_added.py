"""engines/dva/value_added.py -- TTM (trailing twelve months) Total Value Added engine.
...
Usage:
    from skills.cvm.calculations.engines.dva.value_added import value_added_at
