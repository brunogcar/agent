"""skills/cvm/governance/_registry.py — Mode registry + auto-discovery.

Central dispatch table for governance modes. Each mode lives in its own file
...
@dataclass
class ModeSpec:
    """Specification for a governance mode.
...
def register_mode(
    ...
    *,
    ...
    """Decorator to register a governance mode.

    Usage in modes/practices.py:
        @register_mode("practices", description="...", params={...})
        def practices(company="") -> dict:
            ...
    """
