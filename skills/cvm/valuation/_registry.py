"""skills/cvm/valuation/_registry.py — Mode registry + auto-discovery.

Central dispatch table for valuation modes. Each mode lives in its own file
...
@dataclass
class ModeSpec:
    """Specification for a valuation mode.

    Attributes:
        name:        Mode name (file name without .py). "ratios", "summary", etc.
...
def register_mode(
    ...
    *,
    ...
    """Decorator to register a valuation mode.

    Usage in modes/ratios.py:
        @register_mode("ratios", description="...", params={...})
        def ratios(company="") -> dict:
            ...
    """
