"""skills/cvm/backtest/_registry.py — Mode registry for backtest skill.

Delegates to skills._base for the shared ModeSpec + register_mode +
build_manifest_modes infrastructure. This file exists to give backtest
...
# Create backtest's own isolated MODES dict + register_mode decorator.
