"""skills/cvm/insider/_registry.py — Mode registry + auto-discovery.

Central dispatch table for insider modes. Each mode lives in its own file
...
@dataclass
class ModeSpec:
    """Specification for an insider mode.

    Attributes:
        name:        Mode name (file name without .py). "history", "by_role", etc.
...
def register_mode(
    ...
    *,
    ...
    """Decorator to register an insider mode.
