...
_METRIC_TOOLTIPS = {
    ...
    "p_ebitda": "P/EBITDA = Preço da Ação / EBITDA por ação. Quanto o mercado paga por R$1 de EBITDA.",
    "p_ev": "P/EV = Market Cap / Enterprise Value. Quanto do EV é composto pelo Market Cap.",
