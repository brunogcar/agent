"""skills/ddm/acoes/_registry.py - Mode registry for the acoes skill.
...
This file gives acoes its own isolated MODES dict and a stable import
path for mode files:
...
# Create acoes's own isolated MODES dict + register_mode decorator.
