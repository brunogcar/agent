"""skills/ddm/focus/_registry.py - Mode registry for the focus skill.
...
This file gives focus its own isolated MODES dict and a stable import
path for mode files:
...
# Create focus's own isolated MODES dict + register_mode decorator.
