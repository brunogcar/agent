"""skills/ddm/poupanca/_registry.py - Mode registry for the poupanca skill.
...
This file gives poupanca its own isolated MODES dict and a stable import
path for mode files:
...
# Create poupanca's own isolated MODES dict + register_mode decorator.
