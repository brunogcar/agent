"""skills/ddm/inflation/_registry.py - Mode registry for the inflation skill.
...
This file gives inflation its own isolated MODES dict and a stable import
path for mode files:
...
# Create inflation's own isolated MODES dict + register_mode decorator.
