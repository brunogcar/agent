"""skills/ddm/fluxo/_registry.py — Mode registry for the fluxo skill.
...
This file exists to give fluxo its own isolated MODES dict + to provide
...
# Create fluxo's own isolated MODES dict + register_mode decorator.
